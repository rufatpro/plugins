...
Путь от корня git: `jetbrains/ai-chat-file-links/` ([`readme.md`](../../readme.md) репозитория).  
...
Репозиторий также предназначен для расширений **VS Code** (`vscode/`, см. [readme.md](../../readme.md)); **этот** пакет — только JetBrains, в VS Code не ставится. В Cursor/VS Code ссылки в чате обрабатывает сам редактор.
...
[MIT](../../license) — свободная лицензия (репозиторий: JetBrains и VS Code). Использование **на свой страх и риск**; см. [license](../../license) (Marketplace JetBrains, VS Code Marketplace / Open VSX). Индекс: [readme.md](../../readme.md). Сборки: [Releases](https://github.com/rufatpro/ide-plugins/releases).
