...
This repository also hosts **VS Code** extensions under `vscode/` (see [repo readme](../../readme.md)); this package is **JetBrains-only** — it does not install in VS Code. In VS Code / Cursor desktop, file links in chat are handled by the editor itself.
