...
Path in repo (JetBrains): `jetbrains/ai-chat-file-links/` (from git root [`README.md`](../../README.md)).  
...
- **JetBrains only** — not a VS Code extension; see the `vscode/` directory in the repo for future **VS Code** targets.
