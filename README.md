...
| [Cursor Chat Prompt Library](vscode/cursor-chat-prompt-library/) | VS Code / Cursor | 0.7.7 | **Ctrl+Alt+T** (primary), **Ctrl+Alt+Shift+P** → **AI chat**; **710** templates | [EN](vscode/cursor-chat-prompt-library/readme.md) · [RU](vscode/cursor-chat-prompt-library/readme_ru.md) |
