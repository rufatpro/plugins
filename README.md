...
| [Python Doc Links](vscode/py-doc-links/) | VS Code / Cursor | 0.2.8 | Ctrl+Click for Python docstring/comment references (`filename.py`, `:py:func:`, `:py:class:`, `:py:data:`, `:py:mod:`, short forms) | [EN](vscode/py-doc-links/readme.md) · [RU](vscode/py-doc-links/readme_ru.md) |
...
| [Cursor Chat Prompt Library RU](vscode/cursor-chat-prompt-library-ru/) | VS Code / Cursor | 0.2.0 | **620** Russian prompt templates (**31** × 20); parallel install with EN version | [RU](vscode/cursor-chat-prompt-library-ru/readme.md) · [EN](vscode/cursor-chat-prompt-library-ru/readme_en.md) |
