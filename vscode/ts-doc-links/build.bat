...
call npx vsce package -o "build\ts-doc-links-%VER%.vsix" --baseContentUrl "https://github.com/rufatpro/ide-plugins/tree/main/vscode/ts-doc-links" > log.1main.log 2> log.1err.log
if %ERRORLEVEL% equ 0 (
