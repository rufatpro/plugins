...
call npx vsce package -o "build\cursor-chat-prompt-library-%VER%.vsix" --baseContentUrl "https://github.com/rufatpro/plugins/tree/main/vscode/cursor-chat-prompt-library" > log.1main.log 2> log.1err.log
if %ERRORLEVEL% equ 0 (
