...
call npx vsce package -o "build\multiline-find-%VER%.vsix" --baseContentUrl "https://github.com/rufatpro/plugins/tree/main/vscode/multiline-find" > log.1main.log 2> log.1err.log
if %ERRORLEVEL% equ 0 (
