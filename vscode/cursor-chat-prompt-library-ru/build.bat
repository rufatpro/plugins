...
call npx vsce package -o "build\cursor-chat-prompt-library-ru-%VER%.vsix" --baseContentUrl "https://github.com/rufatpro/ide-plugins/tree/main/vscode/cursor-chat-prompt-library-ru" > log.1main.log 2> log.1err.log
if %ERRORLEVEL% equ 0 (
